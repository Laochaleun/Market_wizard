...
def main() -> None:
    ...
    # ecommerce domain: Amazon 2023 + Allegro
    ...
    ecom_y = np.concatenate([amz_y, all_y])
    ecom_scores = np.concatenate([amz_scores, allegro_scores])
    if args.optimize == "off1":
